...
for r in range(num_seeds):
    ...
    def test():
      ...
      with torch.no_grad():
        ...
        print('Epoch #{:.4f} | Test set: Avg. loss: {:.4f}, Accuracy: {}/{} ({:.0f}%)\n'.format(
        epoch,test_loss, correct, len(test_loader.dataset),
        test_accuracy))

    fname_test_acc = method + '_MNIST_testacc_rs'+str(r)+'.npy'
    fname_test_loss = method + '_MNIST_testloss_rs'+str(r)+'.npy'
    fname_train_acc = method + '_MNIST_trainacc_rs'+str(r)+'.npy'
    fname_train_loss = method + '_MNIST_trainloss_rs'+str(r)+'.npy'
    fname_time = method + '_MNIST_time_rs'+str(r)+'.npy'
    ...
    np.save(fname_time, time_tracker)
